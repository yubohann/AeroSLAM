...
{
  // Undefined fromHexString() input: boost 1.46 silently accepted it (and
  // produced something else), modern boost throws. Accept either behavior.
  std::string s("da7c242f-2efe-5175-9961-49cc621b80b9");
...
{
  // Undefined fromHexString() input: boost 1.46 accepted it, modern boost
  // throws. Accept either behavior.
  std::string s("da7c242f-2efe-5175-9961-49cc621b80b9");
