 ...
 * @brief Dynamic Voronoi distance map and Voronoi diagram implementation.
 * @author Unknown (third-party); Zhang Dingkun (repository integration)
 * @date 2026-03-17
 * @version 1.0
 *
 * @note This file appears to be derived from a third-party implementation.
 */
